    ...
    <div>
        <Navbar />
         <div className="bg-linear-to-r dark:from-neutral-600/20 from-gray-300/50 dark:to-black/60 to-gray-400 p-5 px-10 space-y-6">
            ...
            <p className="text-gray-800 dark:text-gray-400 text-[14px] max-w-[95%]">
                Welcome to Rẹ́wàCity, where your real estate aspirations meet expert guidance. Explore our comprehensive range of services, each designed to cater to your unique needs and dreams.
            </p> 
        </div>
        ...
        <section className="bg-gray-300 dark:bg-black/30 p-4 space-y-6" id="valuation">
           <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-[14px] max-w-[95%]">
                Selling your property should be a rewarding experience, and at Rẹ́wàCity, we make sure it is. Our Property Selling Service is designed to maximize the value of your property, ensuring you get the best deal possible. Explore the categories below to see how we can help you at every step of your selling journey
              </p>
           </div>
        ...
        <section className="bg-gray-300 dark:bg-black/30 p-4 space-y-6" id="Management">
           <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-[14px] max-w-[95%]">
                Owning a property should be a pleasure, not a hassle. Rẹ́wàCity's Property Management Service takes the stress out of property ownership, offering comprehensive solutions tailored to your needs. Explore the categories below to see how we can make property management effortless for you
              </p>
           </div>
              ...
              <div className="md:w-5/12 space-y-6">
                <div>
                  ...
                  <p className="dark:text-gray-400 text-gray-600 text-sm max-w-[95%] mt-3">
                   Building a real estate portfolio requires a strategic approach. Rẹ́wàCity's Investment Advisory Service empowers you to make smart investments and informed decisions.
                  </p>
                </div>
