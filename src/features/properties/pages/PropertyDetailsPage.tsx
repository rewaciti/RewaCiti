        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 px-4 pb-6">
            ...
            <button
              ...
              className="bg-white dark:bg-[#1A1A1A] border border-gray-600/30 hover:border-[#703BF7] hover:text-[#703BF7] text-gray-900 dark:text-white px-3 py-3.5 rounded-xl text-base font-medium transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm"
            >
