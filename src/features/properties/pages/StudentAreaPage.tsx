      ...
      <section className="bg-gray-300 dark:bg-black/30 py-2 px-4 pt-4 pb-20" id="StudentPortfolio">
        ...
        <form onSubmit={handleSubmit} className="grid dark:bg-[#1A1A1A] bg-white grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 border border-gray-700/40 rounded-3xl p-6 md:p-10">
          ...
          <div>
            ...
            <CustomDropdown placeholder="Category" value={preferedCategory} options={[{ label: "Self Contain", value: "Self Contain" }, { label: "Studio Apartment", value: "Studio Apartment" }, { label: "Mini Flat", value: "Mini Flat" }, { label: "Flat", value: "Flat" }, { label: "Bungalow", value: "Bungalow" }, { label: "Duplex", value: "Duplex" }, { label: "Mansion", value: "Mansion" }, { label: "Villa", value: "Villa" }, { label: "Smart Home", value: "Smart Home" }, { label: "Single Room", value: "Single Room (Shared)" }, { label: "Shared Room", value: "Shared Room" }, { label: "Furnished Apartment", value: "Furnished Apartment" }, { label: "Hostel", value: "Hostel" }, { label: "Land", value: "Land" }, { label: "Mixed-Use Property", value: "Mixed-Use Property" }, { label: "Uncompleted Building", value: "Uncompleted Building" }]} onChange={(val) => setPreferedCategory(val)} />
          </div>
          <div>
