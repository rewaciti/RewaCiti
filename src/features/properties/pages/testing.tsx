        ...
        <>
          ...
          <section className="px-4 mb-5">
              <button
                ...
                className="inline-flex items-center justify-center rounded-xl bg-[#703BF7] px-6 py-3 text-white font-semibold shadow-lg shadow-[#703BF7]/20 hover:bg-[#5c2fe0] transition-colors"
              >
          ...
          <Dialog.Root open={isInquiryModalOpen} onOpenChange={setIsInquiryModalOpen}>
            <Dialog.Portal>
              ...
              <Dialog.Content className="fixed inset-0 z-50 m-4 overflow-y-auto rounded-3xl bg-white dark:bg-[#111111] border border-gray-600/30 p-6 shadow-2xl max-w-3xl mx-auto my-10">
                <div className="flex items-start justify-between gap-4 mb-6">
                  <div>
                    <Dialog.Title className="text-2xl font-semibold text-gray-900 dark:text-white">Enquire About {property.name}</Dialog.Title>
                    <Dialog.Description className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Send a message about this property and our team will contact you with more details.
                    </Dialog.Description>
                  </div>
                  <Dialog.Close asChild>
                    <button className="rounded-full border border-gray-300 bg-white/90 text-gray-900 p-2 hover:bg-gray-100 dark:border-gray-700 dark:bg-[#1A1A1A] dark:text-white">
                      <FiX />
                    </button>
                  </Dialog.Close>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md px-4 py-2 text-sm focus:outline-none focus:border-[#703BF7] text-gray-900 dark:text-white"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      className="w-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md px-4 py-2 text-sm text-gray-900 dark:text-white"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-gray-100 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md px-4 py-3 text-sm focus:outline-none focus:border-[#703BF7] text-gray-900 dark:text-white"
                    />
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <input
                      type="checkbox"
                      className="mt-1 h-4 w-4 rounded border-gray-300 text-[#703BF7] focus:ring-[#703BF7]"
                      checked={agreed}
