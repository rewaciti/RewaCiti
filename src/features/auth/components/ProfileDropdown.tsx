...
const ProfileDropdown = ({ isOpen, onClose, isMobile }: ProfileDropdownProps) => {
  const { logout, setCustomer, setCompanyId } = useAuthStore();
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center">
            <button
              ...
              className="flex items-center gap-1.5 text-red-600 dark:text-red-400 hover:underline text-xs font-semibold cursor-pointer"
            >
              <FiLogOut size={14} />
              Logout
            </button>
