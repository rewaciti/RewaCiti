...
function Footer() {
  ...
  return (
    <div className="">
      <div
        className="relative py-10 px-5 bg-cover"
        style={{
        ...
        <div className="relative sm:flex justify-between items-center space-y-6 sm:space-y-0">
          <div className="space-y-3">
            ...
            <p className="dark:text-gray-400 text-gray-200 w-[90%]">
              ...
              advice, RewaCiti is here to assist you every step of the way. Take
          ...
          <Link
            to="/properties"
            className="bg-[#703BF7] hover:bg-[#9677df] text-white px-3 py-2 rounded text-sm sm:w-[30%] w-full inline-flex justify-center"
          >
            Explore Properties
          </Link>
        </div>
      ...
      <div className="py-8 px-4 lg:flex space-y-10 lg:space-y-0 justify-between">
        <div className="mr-[5%]  space-y-4">
          ...
          >
            ...
            <span className="text-black dark:text-white">RewaCiti</span>
          </Link>
          <div>
          ...
          <form
            ...
            className="flex items-center p-2 rounded overflow-hidden border dark:border-gray-400/30 border-gray-900 lg:w-[250px] w-full"
          >
            <input
              type="email"
        ...
        <div className="w-full lg:w-[90%] mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 xl:gap-8 lg:gap-4 h-fit divide-x md:divide-x-0 dark:divide-gray-400/30 divide-gray-900/30">
          {/* COLUMN 1 — Home */}
          <div className="p-4">
            <h3 className="dark:text-gray-400 text-gray-600 font-semibold mb-5">
              <Link to="/">Home</Link>
            </h3>
            <ul className="space-y-5 text-sm">
              <li>
                <Link
                  to="/#features"
                  className="hover:text-[#703BF7] text-black dark:text-white dark:hover:text-[#703BF7] cursor-pointer"
                >
                  Features
                </Link>
              </li>
      ...
      <div className="w-full dark:bg-[#1A1A1A] bg-gray-400 py-4">
        <div className="w-[95%] mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-gray-900 dark:text-gray-500 text-sm flex flex-col md:flex-row items-center gap-2">
            ...
            <Link
              to="/terms"
              className="hover:text-[#703BF7] text-gray-900 dark:text-gray-500 text-sm dark:hover:text-[#703BF7] cursor-pointer"
            >
              Terms.
            </Link>
            <Link
          ...
          <div className="flex gap-2">
            <a
              ...
              className="text-gray-400 hover:text-white hover:bg-blue-500 rounded-full w-8 h-8 bg-black items-center justify-center flex p-2"
            >
              <FaLinkedin />
            </a>
            <a
              href="https://x.com/RewaCiti_001"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:bg-white hover:text-black rounded-full w-8 h-8 bg-black items-center justify-center flex"
            >
              <FaXTwitter />
            </a>
            <a
              href="https://www.instagram.com/rewaciti/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white hover:bg-pink-500 rounded-full w-8 h-8 bg-black items-center justify-center flex"
            >
              <FaInstagram />
            </a>
            <a
              href="https://www.youtube.com/@RewaCiti"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white hover:bg-red-500 rounded-full w-8 h-8 bg-black items-center justify-center flex"
            >
              <FaYoutube />
            </a>
          </div>
